    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f0f9f4]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-secondary font-medium">Loading your farm data...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-border/50">
        <div className="bg-accent/10 rounded-xl p-4 mb-4">
          <p className="text-sm font-medium text-accent-foreground mb-1">Premium Plan</p>
          <p className="text-xs text-muted-foreground mb-3">Your subscription renews in 12 days.</p>
          <Button size="sm" variant="outline" className="w-full bg-white border-accent/20 text-accent-foreground hover:bg-accent/5">Manage</Button>
        </div>
        <Button variant="ghost" className="w-full justify-start gap-3 text-red-600 hover:text-red-700 hover:bg-red-50" onClick={handleSignOut}>
        ...
        <header className="bg-white border-b border-border sticky top-0 z-10 px-6 py-4 flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <div className="relative hidden md:block w-64">
              ...
              <Input placeholder="Search crops, sensors..." className="pl-9 bg-slate-50 border-slate-200" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="border-none shadow-md bg-gradient-to-br from-blue-500 to-blue-600 text-white overflow-hidden relative">
                ...
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg font-medium opacity-90">Weather</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-end gap-2 mb-2">
                    <span className="text-4xl font-bold">24°C</span>
                    <span className="text-sm opacity-80 mb-1">Partly Cloudy</span>
                  </div>
              ...
              <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Last checked 5m ago</p>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-bold text-secondary">Field Overview</h2>
                  <Button variant="outline" className="text-primary border-primary/20 hover:bg-primary/5">View Map</Button>
                </div>
                    ...
                    <Card key={field} className="group hover:border-primary/50 transition-all duration-300">
                      <CardContent className="p-0">
                        <div className="flex flex-col sm:flex-row">
                          ...
                          {/* farming field aerial view agriculture green crops */}
                          ...
                          <div className="p-5 flex-1 flex flex-col justify-center">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h3 className="font-bold text-lg text-secondary group-hover:text-primary transition-colors">Soybean Plantation</h3>
                                <p className="text-sm text-muted-foreground">Planted: Oct 15, 2023 • 45 Hectares</p>
                              </div>
                            ...
                            <div className="flex justify-between items-center text-sm">
                              <span className="text-muted-foreground">Growth Stage: Flowering</span>
              ...
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-secondary">Action Needed</h2>
                ...
                <Card className="border-l-4 border-l-yellow-500 shadow-sm">
                  <CardContent className="p-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h4 className="font-bold text-secondary text-sm">Irrigation Required</h4>
                        <p className="text-xs text-muted-foreground mt-1">Field B-2 moisture levels dropped below 30%.</p>
                        <Button size="sm" className="mt-3 w-full bg-yellow-500 hover:bg-yellow-600 text-white border-none shadow-none">Schedule Irrigation</Button>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-l-4 border-l-red-500 shadow-sm">
                  <CardContent className="p-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h4 className="font-bold text-secondary text-sm">High Temp Alert</h4>
                        <p className="text-xs text-muted-foreground mt-1">Greenhouse 3 exceeding max temp threshold.</p>
                        <Button size="sm" variant="destructive" className="mt-3 w-full shadow-none">Check Systems</Button>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-primary/5 border-primary/20">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base text-primary">Upcoming Harvest</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-medium text-secondary">Corn Field C-1</p>
                        <p className="text-xs text-muted-foreground">Estimated Yield: 12 Tons</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
